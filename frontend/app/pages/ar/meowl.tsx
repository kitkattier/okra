...
class DeviceOrientationControls extends EventDispatcher {
  ...
  constructor(object, options = {}) {
    ...
    this.disconnect = function () {
      ...
      window.removeEventListener(scope.orientationChangeEventName, onDeviceOrientationChangeEvent);
    ...
    this.update = function ({ theta = 0 } = { theta: 0 }) {
      ...
      if (device) {
        ...
        if (isIOS) {
          ...
          const currentEuler = new Euler().setFromQuaternion(currentQuaternion, "YXZ");
          ...
          currentEuler.y = MathUtils.degToRad(360 - device.webkitCompassHeading);
    ...
    this.getAlpha = function () {
      ...
      return device && device.alpha ? MathUtils.degToRad(device.alpha) + scope.alphaOffset : 0;
    };
