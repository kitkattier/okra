...
const FakeCircle = React.forwardRef<HTMLDivElement, CircleProps>((props, ref) => {
  const {
  ...
  const hsva = (
    typeof color === "string" && validHex(color) ? hexToHsva(color) : color || {}
  ) as HsvaColor;
...
FakeCircle.displayName = "FakeCircle";

export default FakeCircle;
